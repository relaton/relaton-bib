module Relaton
  module Bib
    class TypedTitleStringCollection
      ...
      # @param title [Array<Relaton::Bib::TypedTitleString, Hash>]
      ...
      # @param title [Relaton::Bib::TypedTitleString]
      # @return [self]
      def <<(title)
        titles << title
        self
      ...
      # @param tcoll [Relaton::Bib::TypedTitleStringCollection]
      # @return [Relaton::Bib::TypedTitleStringCollection]
      def +(tcoll)
      ...
      # @param lang [String]
      # @return [Array<Relaton::Bib::TypedTitleString]
    ...
    class TypedTitleString
      ...
      # @return [Relaton::Bib::FormattedString]
      attr_reader :title

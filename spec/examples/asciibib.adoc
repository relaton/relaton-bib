...
title.format:: text/plain
type:: standard
[docid:: {type: "ISO", id: "TC211"}, docid:: {type: "isbn", id: "ISBN"}, docid:: {type: "lccn", id: "LCCN"}, docid:: {type: "issn", scope: "series", id: "ISSN"}, docid:: {type: "URN", id: "urn:iso:std:iso:123:stage-90.93:ed-3:en,fr"}]docnumber:: 123456
edition:: 1
language:: en
language:: fr
script:: Latn

...
# relations are an array of type, bibitem, and locality.
# bibitem contains any of the attributes of a bibliographic item.
# locality is an array of locality_stack which is an array of hash of type, reference_from, and optionally reference_to
relation:
  - type: updates
    bibitem:
...
relation.bibitem.locality.type:: page
relation.bibitem.locality.reference_from:: 7
relation.bibitem.locality.reference_to:: 10
relation::
relation.type:: updates
